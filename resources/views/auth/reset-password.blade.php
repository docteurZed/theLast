...
<form method="POST" action="{{ route('password.store') }}">
    ...
    <div class="font-semibold">
        <div class="mb-6">
            ...
            <input type="email" id="email" name="email" class="border rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-yellow-600 focus:border-yellow-600 focus:outline-none @error('email') border-red-600 @enderror" placeholder="docteur@docteur.com" value="{{ old('email', $request->email) }}" required />
            @if ($errors->has('email'))
