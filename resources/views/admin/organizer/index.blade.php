                                    ...
                                    <div class="modal fade" id="edit-admin-payment-{{ $admin->id }}" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('admin.organizer.updatePaymentStatus', ['id' => $admin->id]) }}" method="post">
                                                    @csrf
                                                    @method('PUT')
                                    ...
                                    <div class="modal fade" id="edit-admin-{{ $admin->id }}" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('admin.organizer.update', ['id' => $admin->id]) }}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PUT')
                                                <div class="modal-body px-4">
                                                    <div class="row gy-2">
                                    ...
                                    <div class="modal fade" id="delete-admin-{{ $admin->id }}" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('admin.organizer.destroy', ['id' => $admin->id]) }}" method="post">
                                                    @csrf
                                                    @method('DELETE')
                                                <div class="modal-body px-4">
...
<script>
    ...
    function toggleAdminStatut(adminId) {
        ...
        const routeUrl = "{{ route('admin.organizer.toggleIsActive', ['id' => 'ADMIN_ID']) }}".replace('ADMIN_ID', adminId);
