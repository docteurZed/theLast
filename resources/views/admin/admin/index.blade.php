                                    ...
                                    <div class="modal fade" id="edit-admin-payment-{{ $admin->id }}" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('admin.admin.updatePaymentStatus', ['id' => $admin->id]) }}" method="post">
                                                    @csrf
                                                    @method('PUT')
...
<script>
    ...
    function toggleAdminStatut(adminId) {
        ...
        const routeUrl = "{{ route('admin.admin.toggleIsActive', ['id' => 'ADMIN_ID']) }}".replace('ADMIN_ID', adminId);
