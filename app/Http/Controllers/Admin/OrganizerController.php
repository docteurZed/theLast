...
class OrganizerController extends Controller
{
    ...
    public function index()
    {
        ...
        $organizers = $this->userService->showAll('organizer');
    ...
    public function store(UserRequest $request)
    {
        ...
        $user = $this->userService->create($request, 'organizer', true);
    ...
    public function updatePaymentStatus(Request $request, $id)
    {
        ...
        $organizer = $this->userService->updatePaymentStatus($id, $request->amount, null, 'add');

        $this->paymentService->create($request, $organizer->id);
